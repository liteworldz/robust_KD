...
class LossCalulcator(nn.Module):
    ...
    def forward(self, outputs, labels, teacher_outputs=None):
        ...
        Reference: https://github.com/peterliht/knowledge-distillation-pytorch
                   https://pytorch.org/docs/stable/generated/torch.nn.KLDivLoss.ht
        """
        # Distillation Loss
        ...
        total_loss = ( hard_target_loss * self.distillation_weight) + soft_target_loss  * (1 -  self.distillation_weight)
